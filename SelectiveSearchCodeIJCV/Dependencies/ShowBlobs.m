function images = ShowBlobs(blobs, numRow, numCol, image, minSize, imNames)
...
for i=1:length(blobs)
    ...
    if blobs{i}.size > minSize
        images{idx} = Blob2Image(blobs{i}, image); % Blob2Image(p code)
        if doNames
...
% end
% save region images; % chun edit 0613
