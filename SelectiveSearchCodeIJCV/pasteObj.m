function composition = pasteObj(regionInfo,finalRegion,bestR,backgroundId)
%% background voting
% [dbAttribute] = xlsread('../caltech101_attribute.xlsx','Sheet2');
load('cal101/caltech101_Silhouettes_Mfile/cal101Silhouettes50.mat');
cal101Path = 'cal101/RandomizedCaltech101Crop/';
cal101MaskPath = 'cal101/RandomizedCaltech101MasksCrop/';
...
% %-------------------------------------------------------------------------------
%% change sequence by coordinate Y ????y?y???A???Ky???p??
...
TargIm = imresize(TargIm,[125 177]);
% imshow(background);
for i =1:RegionNum
